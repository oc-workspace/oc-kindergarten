# OC Kindergarten Naming Options

## Recommendation

Use `OC Kindergarten`.

It is clear, professional, and accurately describes the goal: small-batch personalized kindergarten to media, companies, partners, or recruiting contacts. It avoids the negative connotation of “bulk email” or “mass mail.”

Suggested usage:

- Product/project name: `OC Kindergarten`
- Main module name: `Kindergarten`
...
- `/admin/kindergarten/contacts`
- `/admin/kindergarten/campaigns`
- `/admin/kindergarten/campaigns/new`
- `/admin/kindergarten/campaigns/[id]`
...
> OC Kindergarten is an internal tool for small-batch personalized email kindergarten, contact management, and campaign delivery tracking.

## Option 1: OC Kindergarten
...
- Professional.
- Easy to understand.
- Works for media kindergarten, company kindergarten, partnership kindergarten, and hiring-related kindergarten.
...
- Does not strongly express campaign tracking or kindergarten.
...
- Users may not immediately know it is an email kindergarten tool.
...
- Heavier than the current small-batch personalized kindergarten scope.
...
Use `OC Kindergarten` as the project name.
