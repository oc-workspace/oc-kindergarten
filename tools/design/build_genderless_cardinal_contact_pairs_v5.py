#!/usr/bin/env python3
"""Build review-ready 48x64 cardinal walk contact pairs."""
...
SHEET = RUN_DIR / "genderless-child-cardinal-contact-pairs-4x2-48x64.png"
META = RUN_DIR / "genderless-child-cardinal-contact-pairs-48x64-meta.json"
...
def main() -> None:
    ...
    for row, direction in enumerate(DIRECTIONS):
        ...
        for col, forward_foot in enumerate(FORWARD_FEET):
            source = Image.open(
                PROCESSED_DIR / f"cardinal-contact-{source_index}.png"
            ).convert("RGBA")
    ...
    preview.resize(
        ...
        Image.Resampling.NEAREST,
    ).save(PREVIEWS_DIR / "genderless-child-cardinal-contact-pairs-preview-6x.png")
        ...
        json.dumps(
            {
                ...
                "action": "cardinal walking contact pairs",
        ...
        json.dumps(
            {
                ...
                "preview": str(
                    (
                        PREVIEWS_DIR
                        / "genderless-child-cardinal-contact-pairs-preview-6x.png"
                    ).relative_to(ROOT)
                ),
